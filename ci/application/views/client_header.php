...
$this->load->helper('form');
 $this->load->helper('url');?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url()?>css/mPurpose-master/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo base_url()?>css/mPurpose-master/css/icomoon-social.css">
        <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,600,800' rel='stylesheet' type='text/css'>

        <link rel="stylesheet" href="<?php echo base_url()?>css/mPurpose-master/css/leaflet.css" />
		<!--[if lte IE 8]>
		    <link rel="stylesheet" href="css/leaflet.ie.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo base_url()?>css/mPurpose-master/css/main.css">

        <script src="<?php echo base_url()?>js/mPurpose-master/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<!-- auto complete -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
<script type="text/javascript">var base_url="<?php echo base_url()?>";</script>
       <script type="text/javascript" src="<?php echo base_url()?>js/client/startupreg.js"></script>
       <script type="text/javascript" src="<?php echo base_url()?>js/client/mentorreg.js">
    </script>
     <script type="text/javascript" src="<?php echo base_url();?>js/client/freelancevalidation.js"></script>
     <script type="text/javascript" src="<?php echo base_url()?>js/client/testimonial.js">
    </script>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>css/client/startupreg.css">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#city").autocomplete({
            source:"<?php echo base_url();?>index.php/Cofounder/searchcity/"
        });
    });
        </script>
<!-- ///////////// -->
        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="index"><img src="<?php echo base_url()?>css/mPurpose-master/img/co-founder-logo.png" alt="Multipurpose Twitter Bootstrap Template"></a></li>
						<li>
							<a href="index">Home</a>
						</li>
						<li class="has-submenu">
							<a href="#">StartUp</a>
								...
								<div class="mainmenu-submenu-inner"> 
									<div>
										<ul>
											<li><a href="startupreg">StartUp</a></li>
											<li><a href="mentorreg">Mentor</a></li>
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										<h4>Homepage</h4>
										<ul>
											<li><a href="index">Homepage (Sample 1)</a></li>
