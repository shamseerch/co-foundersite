...
$this->load->helper('form');
 $this->load->helper('url');?>
    ...
    <head>
		...
		<link rel="stylesheet" href="<?php echo base_url()?>css/mPurpose-master/css/m.css">
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        <script src="<?php echo base_url()?>js/mPurpose-master/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url();?>js/freelancevalidation.js"></script>
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										...
										<h4>Freelancer</h4>
										<ul>
											<li><a href="freelancer">Freelancer Registration</a></li>
											<li><a href="company">Company Registration</a></li>
											<li><a href="frequest">Freelancer Request</a></li>
